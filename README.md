...
| --- | --- | --- |
| [linux-system-monitor](https://github.com/jiyoon99/linux-system-monitor) | Linux 서버 상태, Docker 상태, Ollama 로컬 AI 분석을 제공하는 모니터링 대시보드 | Python, FastAPI, Docker, nginx, Chart.js, Ollama |
| [linux-desktop-widget](https://github.com/jiyoon99/linux-desktop-widget) | Docker, 로컬 서비스, Ollama 상태를 데스크톱에서 확인하는 GTK 위젯 | Python, GTK, Docker, Ollama |
| [linux-chess-portfolio](https://github.com/jiyoon99/linux-chess-portfolio) | 실시간 체스 서비스를 기반으로 한 백엔드 및 Linux 운영 포트폴리오 | Go, WebSocket, PostgreSQL, Redis, Docker |
